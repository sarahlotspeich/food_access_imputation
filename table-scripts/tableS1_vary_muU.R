...
# straight-line proximity to healthy foods, as controlled by the mean //
# $\mu_U$ of the errors $U$." //////////////////////////////////////////
# //////////////////////////////////////////////////////////////////////
...
# //////////////////////////////////////////////////////////////////////
file_urls = c(paste0("https://raw.githubusercontent.com/sarahlotspeich/food/main/sims-data/vary_muU/proximity_N", rep(c(390, 2200), each = 5), 
...
## Change column names 
colnames(res_summ) = c("$\\pmb{N}$", "$\\pmb{\\mu_U}$", 
