# //////////////////////////////////////////////////////////////////////
# Replicate Table 2 ////////////////////////////////////////////////////
# Caption begins "Simulation results under increasing proportion of ////
# neighborhoods queried to obtain map-based proximity to healthy ///////
# foods, as controlled by $p_V$. ///////////////////////////////////////
# //////////////////////////////////////////////////////////////////////
...
res = read.csv(file = "https://raw.githubusercontent.com/sarahlotspeich/food/main/sims-data/vary_pV_sims_combined.csv")
