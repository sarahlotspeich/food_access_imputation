...
plot_data |> 
  ...
  geom_hline(col = "grey", lwd = 1.5, yintercept = 1, linetype = 2) +
...
ggsave(filename = "figures/fig4_forest_plot_piedmont.png", 
       device = "png", 
       width = 10, 
       height = 5, 
       units = "in")
ggsave(filename = "figures/fig4_forest_plot_piedmont.pdf", 
       device = "pdf", 
       width = 10, 
       height = 5, 
       units = "in")